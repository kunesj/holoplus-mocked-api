...
class CommentContent(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentsMeResponseItemThread(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentsMeResponseItemChannel(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentsMeResponseItemCommunity(msgspec.Struct, kw_only=True, omit_defaults=True):
    icon_url: Annotated[
        str, Parameter(examples=[Example(value="https://asset.holoplus.com/communities/hololive/icon_hololive.png")])
    ] = msgspec.field()


class CommentsMeResponseItem(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentsMeResponse(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentUserRole(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentUserIcon(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentUser(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class Comment(msgspec.Struct, kw_only=True, omit_defaults=True):
...
class CommentsResponse(msgspec.Struct, kw_only=True, omit_defaults=True):
